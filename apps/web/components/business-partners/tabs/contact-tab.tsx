...
import { Button, Checkbox, Input, Label } from '@petiatrics/ui';
      ...
      <div>
        <div className="mb-3 flex items-center justify-between">
          ...
          <Button
            ...
            size="sm"
            variant="outline"
            onClick={() => append({ name: '', email: null, isPrimary: false })}
          >
            ...
            <div key={field.id} className="rounded-lg border p-4">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input {...register(`contacts.${index}.position`)} placeholder="e.g. Purchasing Manager" />
                </div>
