...
import { Search, Filter, Plus, MoreVertical, Download, Mail, Phone, MapPin, PawPrint, DollarSign, Calendar, Edit, Trash2, Eye, } from 'lucide-react';
...
export function Clients() {
    ...
    const clientAppointments = selectedClient
        ? mockAppointments.filter(apt => clientPets.some(pet => pet.id === apt.petId))
        : [];
    return (<div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1 relative">
          ...
          <input type="text" placeholder="Search clients by name, email, or phone..." className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"/>
        </div>
      ...
      <Card>
        <CardContent className="p-0">
          <div className="overflow-x-auto">
            ...
            return (<tr key={client.id} className="hover:bg-gray-50 cursor-pointer" onClick={() => setSelectedClient(client)}>
                      ...
                      <td className="px-6 py-4">
                        {client.outstandingBalance > 0 ? (<span className="text-sm font-medium text-orange-600">
                            ${client.outstandingBalance.toFixed(2)}
                          </span>) : (<Badge className="bg-green-100 text-green-700 hover:bg-green-100">
                            Paid
                          </Badge>)}
                      </td>
              ...
              <Tabs defaultValue="info" className="mt-4">
                ...
                <TabsContent value="pets" className="mt-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {clientPets.map((pet) => (<Card key={pet.id}>
                        <CardContent className="pt-6">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-2 mt-2">
                                ...
                                <Badge className={pet.status === 'healthy' ? 'bg-green-100 text-green-700 hover:bg-green-100' :
                ...
                <TabsContent value="appointments" className="mt-4">
                  <div className="space-y-3">
                    {clientAppointments.length > 0 ? (clientAppointments.map((apt) => (<Card key={apt.id}>
                          <CardContent className="pt-6">
                            <div className="flex items-center justify-between">
                              <div>
                        ...
                        </Card>))) : (<p className="text-center text-gray-500 py-8">No appointments found</p>)}
                  </div>
                </TabsContent>
              </Tabs>
            </>)}
