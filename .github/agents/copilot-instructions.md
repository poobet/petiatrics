...
Auto-generated from all feature plans. Last updated: 2569-06-01
...
- TypeScript 5.x (strict mode) + NestJS 10, Next.js 14 App Router, Prisma 5, shadcn/ui, EventEmitter2, class-validator (008-inventory-management)
- PostgreSQL (all stock data — transactional, audit-critical) (008-inventory-management)
...
## Recent Changes
- 008-inventory-management: Added TypeScript 5.x (strict mode) + NestJS 10, Next.js 14 App Router, Prisma 5, shadcn/ui, EventEmitter2, class-validator
- 008-inventory-management: Added [e.g., Python 3.11, Swift 5.9, Rust 1.75 or NEEDS CLARIFICATION] + [e.g., FastAPI, UIKit, LLVM or NEEDS CLARIFICATION]
